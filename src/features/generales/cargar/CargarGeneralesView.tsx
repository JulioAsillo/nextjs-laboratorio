...
import { purgeAll } from '@/features/usuarios/cargar/delete-fuente';
...
import { generalesFuentes as fuentes } from '@/config/fuentes';

/** Caché propia de ESTA pantalla -> aísla el "cargado/estado" de Generales y Especiales. */
const CACHE_KEY = 'cargar:generales';
...
export default function CargarGeneralesView() {
  ...
  return (
    <AppShell
      ...
      breadcrumb={['Certificación de Generales y Especiales', 'Cargar Información']}
      actions={
        <>
