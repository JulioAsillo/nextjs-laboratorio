...
export const fuentes: Fuente[] = [
  ...
  },
  {
    ...
    slots: [
      { fileName: 'activos_gdh', label: 'Activos GDH', columns: ['NÚMERO ID', 'NOMBRES', 'APELLIDO PATERNO', 'APELLIDO MATERNO', 'GRUPO DE PERSONAL', 'CÓDIGO FUNCIÓN', 'FUNCIÓN', 'CÓDIGO DE UN.ORG.', 'UNIDAD ORGANIZATIVA', 'FECHA', 'SOCIEDAD', 'ÁREA DE NÓMINA', 'AREA BCP', 'DIVISIÓN BCP', 'CÓDIGO SERVICIO', 'TEXTO SERVICIO'] },
