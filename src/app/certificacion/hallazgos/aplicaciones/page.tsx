...
import { fetchHallazgos } from '@/lib/api';
...
export default function AplicacionesPage() {
  const { data, error, isValidating, mutate } = useSWR('hallazgos-aplicaciones', fetchHallazgos, {
      ...
      {error && !loaded && (
        <div className="flex flex-col items-start gap-3 rounded-lg border border-error/30 bg-error/5 p-6 text-body-md text-error">
          <span>
            ...
            <code className="font-mono">/hallazgos/apps</code> esté activo y la variable{' '}
