...
/**
 * Tarjetas-resumen de escenarios para el Hallazgo Base de Datos.
 * Muestra el conteo de cada flag de escenario de la hoja activa.
 */
export function BdSummaryCards({ stats, total }: { stats: EscenarioStat[]; total: number }) {
  return (
